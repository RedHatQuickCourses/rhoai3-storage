 ...
 * Update the cluster-storage.sh with your avialable storage classes.
----
...
./deploy/cluster-storage.sh ai-factory-lab personal-scratch-1 20 rwo

# 3. Provision Shared Team Storage (ReadWriteMany) - 100GB
./deploy/cluster-storage.sh ai-factory-lab team-golden-data 100 rwo
----
...
./deploy/dataconnect.sh ai-factory-lab corp-data-lake
----
